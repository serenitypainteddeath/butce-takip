...
class StatsViewModel @Inject constructor(
    ...
    // Seçilen türe göre kategori toplamlarını döndüren fonksiyon
    fun getCategoryTotalsByType(type: TransactionType): StateFlow<List<CategoryTotal>> {
        return when (type) {
            TransactionType.INCOME -> incomeCategoryTotals
            TransactionType.EXPENSE -> expenseCategoryTotals
        }
    }
} 